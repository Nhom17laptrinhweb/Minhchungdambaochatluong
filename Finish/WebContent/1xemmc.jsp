 ...
 <div class="col-md-4 ">
	...
	<div id="jstree">
	    ...
	    <ul>
			    ...
			    <c:choose>
			    <c:when test ="${row.tinhtrang==1 }">
			    <li><a href="1nhapminhchung.jsp?a=${row.tenmc } &b=${row.nguoinhap} &c=${row.mota} &d=${row.nguoitao} &e=${row.linkfile} &f=${row.mamc}"><c:out value="${row.tenmc}"/></td>
			        <ul>
